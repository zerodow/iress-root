package com.equix.systemsetting;
...
public class OpenSettingsModule extends ReactContextBaseJavaModule {
  ...
  @ReactMethod
  public void openSecuritySettings(Callback cb) {
    Activity currentActivity = getCurrentActivity();
    ...
    try {
      currentActivity.startActivity(new Intent(android.provider.Settings.ACTION_SECURITY_SETTINGS));
      cb.invoke(true);
    } catch (Exception e) {
      cb.invoke(e.getMessage());
    }
