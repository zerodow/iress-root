...
class SearchPortfolio extends React.Component {
	...
	render() {
		...
		// push openprice
		result.push(<OpenPriceHeader onPress={this.onPress} />);

		if (!this.state.isCollapsed) return result;
		result.push(
			<PriceContent
		...
		result.push(<ListTransaction symbol={this.props.symbol} />);

		// NewOpenPriceRow

		// if (Platform.OS === 'android') {
		// 	result.push(<View style={{ height: 1 * 24 }} />);
		// }
