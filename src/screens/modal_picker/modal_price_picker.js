...
export class ModalPicker extends Component {
                ...
                <View>
                    <TouchableOpacity
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', height: 48 }}>
                            ...
                            <Text testID={`${item.value}`} style={[{ flex: 8, color: this.checkHideChevron(this.props.selectedItem, item.value) && !this.state.showDatePicker ? CommonStyle.fontBlue : CommonStyle.fontColor }, this.props.disableCapitalize ? {} : { textTransform: this.props.textTransform || 'capitalize' }]}>{item.value}</Text>
                            {
                ...
                ? <View>
                    <TouchableOpacity
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', height: 52 }}>
                            <Text testID={`${item.value}`} style={{ flex: 8, color: this.state.showDatePicker ? CommonStyle.fontBlue : CommonStyle.fontColor, textTransform: 'capitalize' }}>{item.value.toUpperCase()}</Text>
                            {
    ...
    render() {
        ...
        const ratio = this.props.ratio || 0.7
        return (
            <Modal
                ...
                <TouchableWithoutFeedback onPressIn={this.onDismiss}>
                    <View style={{
                ...
                <View style={{
                    ...
                    <FlatList
                        ...
                        extraData={this.state.showDatePicker}
                    />
                </View>
