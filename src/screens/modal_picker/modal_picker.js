                ...
                <View>
                    <TouchableOpacity
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', height: 52 }}>
                            ...
                            <Text testID={`${item.value}`} style={[{ flex: 8, color: this.checkHideChevron(this.props.selectedItem, item.value) && !this.state.showDatePicker ? CommonStyle.fontBlue : CommonStyle.fontColor }, this.props.disableCapitalize ? {} : { textTransform: 'capitalize' }]}>{item.value}</Text>
                            {
            ...
            return (this.props.customDate
                ? <View>
                    <TouchableOpacity
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', height: 52 }}>
                            <Text testID={`${item.value}`} style={{ flex: 8, color: this.state.showDatePicker ? CommonStyle.fontBlue : CommonStyle.fontColor, textTransform: 'capitalize' }}>{item.value}</Text>
                            {
