...
export class NewsWatchlist extends XComponent {
    ...
    updateDataListView(data) {
        if (data && dataStorage.tabNews === TAB_NEWS.RELATED) {
    ...
    getSnapshotData(filterTypeNewSelect) {
        ...
        const filterTypeNew = filterTypeNewSelect || this.props.news.relatedFilterType
    ...
    render() {
        if (this.props.news.isLoadingOnWatchlist) {
            return (
                <View style={{
                            ...
                            ? <View style={{ flex: 1 }}>
                                <View style={{ flex: 1 }}>
                                    <ListView
                                        ...
                                        onEndReaached={this.loadMore}
                                        onEndRechedThreshold={50}
                                        ...
                                        style={{ height, backgroundColor: CommonStyle.backgroundColor }}
                                    />
                                </View>
                                <View style={{ height: 1 }}>
                                </View>
