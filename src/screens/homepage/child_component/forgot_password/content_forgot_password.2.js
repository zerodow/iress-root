...
export class ContentForgotPassword extends XComponent {
		...
		return <TouchableOpacity
			...
			<Text
				style={[homePageDescriptionText,
					{
						color: CommonStyle.fontWhite,
						opacity: this.state.cancelDisable ? 0.78 : 1
					}]}>
				{I18n.t('cancel')}
			</Text>
		</TouchableOpacity>
	...
	renderNewPassword() {
		const extraStyle = { marginBottom: 8 }
		return (
			<View>
				<View style={{
					marginHorizontal: 48,
				...
				<View style={{ paddingTop: marginTopButtons }}>
					{
						this.renderButtonConfirm(extraStyle)
					}
					{
						this.renderButtonCancel()
					}
