...
let OrdersRowPieChart = ({
    ...
    const leftValueAnim = useMemo(() => {
        return multiply(
            multiply(
                divide(min(sub(100, percentValue), 50),
                    50
                ),
                180
            ),
    ...
    const progressColor = side === SIDE.BUY
        ...
        >
            <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                ...
                <Rect isRight isParent diameter={diameter}>
                    <Rect isRight rotate={rightValueAnim} diameter={diameter} isAnimated>
                        <Circle size={diameter} color={progressColor} />
                    </Rect>
                </Rect>
