...
const TakeProfitTab = React.memo(({ onChangeTab, fillColorDefault, styleTextDefault, disablChangeTab, disabledFirstTab }) => {
                ...
                <View style={[
                    ...
                    <TabShapeSecond
                        ...
                        tabs={[
                            ...
                            {
                                title: 'MORE',
                                key: 'MORE_TAKE_PROFIT',
                                value: 'MORE_TAKE_PROFIT',
...
TakeProfitTab.propTypes = {}
TakeProfitTab.defaultProps = {}
const styles = StyleSheet.create({})
export default TakeProfitTab
