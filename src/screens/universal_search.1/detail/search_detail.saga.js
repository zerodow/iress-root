...
import StreamingAction from '~/streaming/StreamComp/reducer'
...
export function* getAllDataSearchDetail() {
	...
	yield put(StreamingAction.changeQuoteData([quote])) // fix loi lay nham gia trong trade infor
