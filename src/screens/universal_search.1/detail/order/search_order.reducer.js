...
const { Types, Creators } = createActions({
	...
	updateRealtime: ['data', 'filterType'],
...
export const updateRealtime = (state, { data, filterType }) => {
	return state.setIn(['listOrderData', filterType, 'listData'], data);
};
...
export const reducer = createReducer(INITIAL_STATE, {
	...
	[Types.UPDATE_REALTIME]: updateRealtime,
