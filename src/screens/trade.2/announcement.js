import { Text, TouchableOpacity, View, PixelRatio } from 'react-native';
import { logAndReport, getUniqueList, deleteNotiNewsByCode, showNewsDetail } from '../../lib/base/functionUtil';
                                ...
                                data.link
                                    ? <TouchableOpacity
                                        ...
                                        <IonIcons
                                            name='md-download'
                                            size={20}
                                            color={this.state.isDisabled ? 'grey' : CommonStyle.fontBlue} />
                                    </TouchableOpacity>
