...
function snapTo(target, snapPoints, best, clb, dragClb, isSibling) {
    ...
    return [
        ...
        // isSibling &&
        //     cond(lessThan(curPointIndex, prePointIndex), [
        //         ...snap(snapPoints[prePointIndex - 1]),
        //         set(prePointIndex, prePointIndex - 1)
        //     ]),
        // isSibling &&
        //     cond(greaterThan(curPointIndex, prePointIndex), [
        //         ...snap(snapPoints[prePointIndex + 1]),
        //         set(prePointIndex, prePointIndex + 1)
        //     ]),
        (clb || dragClb) &&
...
class Interactable extends Component {
    ...
    constructor(props) {
        ...
        this.resetWithSnap = new Value(STATE.UNDETERMINED);
        ...
        const trans = (axis, vaxis, lowerBound, upperBound) => {
            ...
            const testMovementFrames2 = cond(
                eq(this.resetWithSnap, STATE.START),
                [
                    set(last, advance),
                    set(noMoveFrameCount, 0),
                    set(this.resetWithSnap, STATE.UNDETERMINED)
                ]
            );
    ...
    snapTo({ index }) {
        ...
        this.resetWithSnap.setValue(STATE.START);
        this.props.onSnap &&
