...
export default class SurplusVolume extends XComponent {
	constructor(props) {
		super(props);
	...
	onValueChange(newData) {
		...
		if (
			...
			this.dic.value === null ||
			this.dic.value.surplus_volume === undefined ||
			this.dic.value.surplus_volume === null ||
			this.dic.value.surplus_volume !== newData.surplus_volume
		) {
