...
export default class ChangePercent extends XComponent {
    ...
    getDisplay = () => {
        if (this.dic.isLoading) {
            return this.dic.value.trade_price !== undefined && this.dic.value.trade_price !== null ? ` (${formatNumberNew2(this.dic.value.change_percent, PRICE_DECIMAL.PERCENT)}%)` : ' (0.56%)'
        }
        return this.dic.value.trade_price !== undefined && this.dic.value.trade_price !== null ? ` (${formatNumberNew2(this.dic.value.change_percent, PRICE_DECIMAL.PERCENT)}%)` : ' (--%)'
    }
    render() {
        return (
