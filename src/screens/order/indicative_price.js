...
export default class IndicativePrice extends XComponent {
    constructor(props) {
        super(props)
    ...
    onValueChange(newData) {
        ...
        if (
            ...
            this.dic.value === null ||
            this.dic.value.indicative_price === undefined ||
            this.dic.value.indicative_price === null ||
            this.dic.value.indicative_price !== newData.indicative_price
        ) {
