...
export default class BoxShadow extends Component {
    render = () => {
        ...
        const { width = 0, height = 0, color = '#000', border = 0, radius = 0, opacity = 1, x = 0, y = 0, style = {} } = this.props.setting || shadowOpt
        ...
        return (
            <View style={[{ position: 'relative', width: width, height: height }, style]}>
                <Svg height={heightShadow || height + lineWidth * 2 + radius * 2} width={width + lineWidth * 2 + radius * 2} style={{ position: 'absolute', bottom: y - lineWidth, left: x - lineWidth }}>
                    <Defs>
