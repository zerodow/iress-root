...
import logoLogin from '~/img/background_mobile/logo_theme1.png';
import icons from './icons/icons_theme_1';
...
function getTheme() {
	...
	const fontBold = 'SourceSansPro-SemiBold';
	const fontFamily = 'SourceSansPro-Regular';
	const fontLight = 'SourceSansPro-Regular';
	const fontMedium = 'SourceSansPro-SemiBold';
	const fontbold = 'SourceSansPro-SemiBold';
	const fontBuySellWL = 'SourceSansPro-SemiBold';

	const fontPoppinsBold = 'SourceSansPro-SemiBold';
	const fontPoppinsRegular = 'SourceSansPro-Regular';
	const fontPoppinsItalic = 'SourceSansPro-Italic';
	const fontPoppinsLight = 'SourceSansPro-Regular';
	const fontPoppinsMedium = 'SourceSansPro-SemiBold';
	...
	const fontMin = fontSizeStandard - 8 + 2;
	const font10 = fontSizeStandard - 6 + 2;
	const font11 = fontSizeStandard - 5 + 2;
	const font13 = fontSizeStandard - 3 + 2;
	const font15 = fontSizeStandard - 1 + 2;
	const font17 = fontSizeStandard + 1 + 2;
	...
	const font7 = fontSizeStandard - 9 + 2;
	const font6 = fontSizeStandard - 10;
	const fontTiny = fontSizeStandard - 7 + 2;
	const fontSizeXS = fontSizeStandard - 4 + 2;
	const fontSizeXS1 = fontSizeStandard - 5 + 2;
	const fontSizeTen = fontSizeStandard - 6 + 2;
	const fontSizeS = fontSizeStandard - 2 + 2;
	const fontSizeM = fontSizeStandard + 2;
	const fontSizeL = fontSizeStandard + 2;
	const fontSizeXL = fontSizeStandard + 4;
	const fontSizeXXL = fontSizeStandard + 8;
	const font12 = fontSizeStandard - 6 + 1;
	const font16 = fontSizeStandard - 1;
	...
	const color = {
		...
		buy: 'rgb(59, 183, 25)',
		success: '#3BB719',
		modify: 'rgb(255, 255, 255)',
		warning: 'rgb(247, 181, 0)',
		process: 'rgb(247, 181, 0)',
		error: '#DC0032',
		network: '#DC0032',
		sellOpa: 'rgba(220, 0, 50, 0.6)',
		buyOpa: 'rgba(59, 183, 25, 0.6)',
		lightWhite: 'rgb(197, 203, 206)',
		shadow: '#000000',
		turquoiseBlue: 'rgb(255, 255, 255)',
		turquoiseBlueHex: '#FFFFFF',
		disabled: 'rgba(175, 20, 75, 0.25)',
		bgAccount: '#870A3C',
		bgDrawer: '#AF144B',
		icon: '#AF144B',
		select: '#AF144B',
		...
		backBuy: '#AF144B',
		backSell: '#FFFFFF',
		backSellBorder: '#AF144B',
		quantityIcon: '#FFFFFF',
		sellOrderButtonLoading: 'rgba(175, 20, 75, 0.5)',
		buyOrderButtonLoading: 'rgba(175, 20, 75, 0.5)',
		buyBTText: '#FFFFFF',
		dropdown_marketActivities: '#AF144B',
		btnReviewOrderBuy: '#AF144B',
		btnReviewOrderSell: '#AF144B',
		borderAddWLSelected: '#AF144B',
		buy_Orders: '#FFFFFF',
		fontdusk_disable: 'rgba(175, 20, 75, 0.3)',
		tab_disable: '#2D2323',
		textColor: '#ffffff'
	};
	const iconMoveColor = 'rgb(216, 216, 216)';
	const iconAddSymbol = 'rgba(253,253,253,0.5)';
	const statusBarModal = 'rgba(80, 10, 40, 0.87)';
	const lineColor = 'rgba(175, 20, 75, 0.2)';
	const bgCircleDrawer = '#2D2323';
	...
	const fontRed1 = '#DC0032';
	const fontChestnutRose = '#cd5c5c';
	const fontTorchRed = '#ff1643';
	const fontShadowRed = '#DC0032';
	const fontShadowRedOpacity = 'rgba(220, 0, 50, 0.5)';
	const fontPink = '#f28bb0';
	const fontShadow = '#2D23231e';
	const fontGreen = '#3BB719';
	const fontGreenNew = '#3BB719';
	const fontGreen1 = '#3BB719';
	const fontOceanGreen = '#FFFFFF';
	const fontOceanRed = '#FFFFFF';
	const fontOceanGreenOpacity = 'rgba(59, 183, 25, 0.5)';
	const fontShadowGreen = 'rgba(59, 183, 25, 0.7)';
	const fontBlue = '#10a8b2';
	const fontBlue1 = '#FFFFFF';
	...
	const fontDefaultColor = 'rgb(80, 10, 40)';
	const fontDark2 = '#2D2323';
	const fontColorBorderNew = '#F0325A';
	const fontColorButtonSwitch = '#ffffff';
	const fontColorSwitchTrue = '#AF144B';
	const fontDark3 = '#AF144B';
	const fontColorModal = 'rgb(23,27,41)';
	const fontNewRed = '#DC0032';
	const fontDefaultColorOpacity = 'rgba(80, 10, 40,0.85)';

	const fontBorderGray = '#333333';
	const fontBorderNewsUi = 'rgb(54, 60, 78)';
	const fontBorder = '#FFFFFF';
	const fontBlack = '#2D2323';
	const fontSilver = '#bbb';
	const fontAzureRadiance = '#007aff';
	const fontDeepGray = '#808080';
	const fontDeepBlack = '#2D23231e';
	const fontGridChartColor = '#2D23231e';
	...
	const fontIconLeft = '#2D232387';
	const fontNearDark1 = 'rgba(45, 35, 35, 0.87)';
	const fontNearDark2 = 'rgba(45, 35, 35, 0.54)';
	...
	const hightLightColorDown = '#DC0032';
	const hightLightColorDownPercent = '#DC0032';
	const hightLightColorUp = '#00b800';
	const hightLightColorUpPersent = '#00b800';
	const lightGreenBlue = 'rgba(59, 183, 25, 0.3)';
	const reddishPink = 'rgba(220, 0, 50, 0.3)';
	const fontRegentStBlue = '#96b9dd';
	const fontJava = '#19bdc8';
	const fontMandy = 'rgba(233, 45, 35, 35.7)';
	const fontEmerald = 'rgba(59, 183, 25, 0.7)';
	...
	const borderTextBoxGray = 'rgba(45, 35, 35, 0.12)';
	const opacityCos = opacity3;
	const drawerTopBgColor = fontDark;
	const statusBarBgColor = fontDark;
	const statusBarColor = 'rgba(45, 35, 35, 1)';
	const statusBarColorNearBlack = 'rgba(45, 35, 35, 0.3)';
	...
	const colorProduct = 'rgb(255, 255, 255)';
	...
	const searchInputBgColor2 = '#AF144B';
	const fontHeaderPin = fontWhite;
	const companyNameColor = 'rgba(45, 35, 35, 0.3)';
	...
	const backgroundColorNews = '#500A28';
	const ColorTabNews = '#2D2323';
	const backgroundNewSearchBar = '#AF144B';
	const colorTradePrice = '#DC0032';
	const colorEdge = 'rgb(31, 37, 59)';
	const disableBtnSellBorderColor = 'rgba(253,55,84, 0.7)';
	const disableBtnBuyBorderColor = 'rgba(59, 183, 25, 0.7)';
	const borderColorTopButtonConfrim = 'rgba(175, 20, 75, 0.5)';
	const fonttextsellAmend = '#1e1e1e';
	//  font fontColor
	...
	const backgroundColor1 = '#500A28';
	const backgroundColor2 = color.bg;
	const backgroundColorPopup = 'rgba(80, 10, 40,0.7)';
	const backgroundColorNearDark = '#2D2323';
	const text = {
		color: '#c5cbce'
	};
	...
	const upColor = 'rgba(59, 183, 25, 0.6)';
	const downColor = 'rgba(220, 0, 50,0.6)';

	const backgroundBid = 'rgba(59, 183, 25, 0.2)';
	const backgroundAsk = 'rgba(220, 0, 50,0.2)';

	const borderBottomRightRadius = 0;
	const lineColor2 = 'rgba(255,255,255,0.3)';

	const borderColorActive = 'rgba(255, 255, 255, 0.7)';
	let style = {
		images,
		icons,
		UP_COLOR: [59, 183, 25],
	...
	style = {
		...
		iconDrawerSelected: {
			...
			tintColor: btnOrderPositionBgColor,
			width: 20,
			height: 20,
			resizeMode: 'contain'
		},
		...
		modalWrapper: {
			...
			justifyContent: 'center',
			alignItems: 'center',
			backgroundColor: 'rgba(45, 35, 35, 0.3)'
		},
		inputText: {
			fontSize: fontSizeM - 3,
			color: fontColor,
		...
		colorHeaderFindWatchlist: {
			...
			marginTop: Platform.OS === 'ios' ? style.marginSize - 4 : 0,
			alignItems: 'center',
			borderBottomColor: 'rgba(45, 35, 35, 0.12)',
			borderBottomWidth: 1,
			paddingLeft: style.paddingDistance2,
			backgroundColor: fontDark,
			shadowColor: 'rgba(76,0,0,0)',
		...
		historyBar: {
			...
			borderBottomColor: 'rgba(45, 35, 35, 0.12)',
			borderBottomWidth: 0,
			borderTopColor: 'rgba(45, 35, 35, 0.12)',
			borderTopWidth: 1,
			paddingLeft: 16,
			border
		},
		...
		pinVersion2: {
			...
			changePinBackgroundColor: '#500A28',
			pinTitleBackgroundColor: '#171c29'
		},
		headerDrawer: {
			width: WIDTH_DRAWER,
			backgroundColor: color.bgAccount,
			borderBottomRightRadius: borderBottomRightRadius,
			paddingTop: 36,
			paddingLeft: 36,
			overflow: 'hidden',
