#!/usr/bin/env bash
cp -rf config/LogoEquix_Iress_prod/android/ android/app/src/main/res/
...
nextCodePush='qvankqoZtaf_Ambs704NNZsPezfDXj0TjQOWB'
...
cp -rf config/LogoEquix_Iress_prod/android/strings.xml android/app/src/main/res/values/
